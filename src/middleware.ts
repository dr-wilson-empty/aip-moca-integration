...
function addSecurityHeaders(response: NextResponse): NextResponse {
  ...
  response.headers.set(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.air3.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; style-src-elem 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' https://*.solana.com wss://*.solana.com https://*.helius-rpc.com wss://*.helius-rpc.com https://*.quiknode.pro wss://*.quiknode.pro https://*.alchemy.com wss://*.alchemy.com https://*.supabase.co https://*.air3.com wss://*.air3.com https://*.mocachain.org https://*.mocachain.dev; frame-src 'self' https://*.air3.com; frame-ancestors 'none';"
  );
  return response;
}
